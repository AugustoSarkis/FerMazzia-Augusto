...
def unificar_bases_farmaponte_rigoroso():
    ...
    df_historico = pd.read_csv('/home/ubuntu/.2_Dados/FarmaPonte/Historico_Vendas_Farma_Ponte_Consolidado.csv', sep=';')
    df_scraping = pd.read_csv('/home/ubuntu/.2_Dados/FarmaPonte/Scraping_FarmaPonte.csv', sep=';')
    ...
    df_final.to_csv(f"/home/ubuntu/.2_Dados/FarmaPonte/{nome_arquivo_final}", index=False, encoding='utf-8-sig', sep=',')
