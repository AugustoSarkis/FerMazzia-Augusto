...
def unificar_bases_veracruz_rigoroso():
    ...
    df_historico = pd.read_csv('/home/ubuntu/.2_Dados/VeraCruz/Historico_Vendas_Vera_Cruz_Consolidado.csv', sep=';')
    df_scraping = pd.read_csv('/home/ubuntu/.2_Dados/VeraCruz/Scraping_VeraCruz.csv', sep=';')
    ...
    df_final.to_csv(f"/home/ubuntu/.2_Dados/VeraCruz/{nome_arquivo_final}", index=False, encoding='utf-8-sig', sep=',')
