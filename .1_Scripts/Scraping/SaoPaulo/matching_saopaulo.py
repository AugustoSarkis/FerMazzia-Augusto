...
def unificar_bases_farmaponte_rigoroso():
    ...
    df_historico = pd.read_csv('/home/ubuntu/.2_Dados/SaoPaulo/Historico_Vendas_Sao_Paulo_Consolidado.csv', sep=';')
    df_scraping = pd.read_csv('/home/ubuntu/.2_Dados/SaoPaulo/Scraping_SaoPaulo.csv', sep=';')
    ...
    df_final['Nome da Farmácia'] = df_final['Nome da Farmácia'].fillna('SaoPaulo')
