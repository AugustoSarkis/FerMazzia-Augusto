...
def executar_spider_veracruz():
    ...
    print(f"Alvo: {len(links_para_raspar)} produtos. Salvando em 'Dados_VeraCruz/{nome_arquivo}'.")
    print("-" * 60)
    
    with open(f"Dados_VeraCruz/{nome_arquivo}", mode='w', newline='', encoding='utf-8-sig') as arquivo_csv:
