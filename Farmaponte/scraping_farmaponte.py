...
def executar_spider_farmaponte():
    ...
    print(f"Alvo: {len(links_para_raspar)} produtos. Salvando em 'Dados_FarmaPonte/{nome_arquivo}'.")
    print("-" * 60)
    
    # Salvando na raiz do diretório onde o script está rodando
    with open(f"Dados_FarmaPonte/{nome_arquivo}", mode='w', newline='', encoding='utf-8-sig') as arquivo_csv:
